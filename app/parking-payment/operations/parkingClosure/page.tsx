...
export default function Incomes({ userData, setUserData }: { userData: UserData; setUserData: (userdata: UserData) => void; }) {
  ...
  const columns: GridColDef[] = [
    ...
    { field: '', headerName: 'Consecutivo inicial', flex: 1, headerAlign: 'center', align: "center" },
    { field: '', headerName: 'Consecutivo final', flex: 1, headerAlign: 'center', align: "center" },
    { field: '', headerName: 'Concecutipo inicial FE', flex: 1, headerAlign: 'center', align: "center" },
    { field: '', headerName: 'Concecutipo final FE', flex: 1, headerAlign: 'center', align: "center" },
    {
        field: 'actions',
        headerName: 'Acciones',
        flex: 1, 
  ...
  return (
    <section>
      <div className="flex justify-between mb-2">
        ...
        <Button className="w-1/6 p-6 mt-4 px-28">Abrir caja</Button>
        <Button className="w-1/6 p-6 mt-4 px-28" >Informe parcial</Button>
        <Button className="w-1/6 p-6 mt-4 px-28" >+Realizar cierre</Button>
      </div>
          ...
          {() => (
            <div className="flex flex-col items-start w-full p-4">
              <ModalHeader className="flex justify-between w-full">
                <h1 className={`text-2xl ${title()}`}>Esto generará una impresión con los siguientes resúmenes:</h1>
              </ModalHeader>
              <ModalBody className="flex w-full">
                <div className="flex-grow" />
                <div className="flex flex-col items-center w-full">
                  <div className="flex flex-col items-center w-98">
                    <label className="text-xl font-bold text-nowrap w-1/3"> Transacciones efectivo.<br/>
                         Transacciones transferencia.<br/>
                         Dinero recibido.<br/>
                         Dinero devolución.<br/>
                         Medio de pago.</label>
                    <Input
                      placeholder=" "
