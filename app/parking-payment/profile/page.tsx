...
import { Button, CardBody, Select, SelectItem } from "@nextui-org/react";
...
const Profile = () => {
  ...
  const { users, existingUsernames, existingUserEmails } = UseUsers();
  const {
    register,
    ...
    resolver: zodResolver(
      editProfileSchema(existingUsernames, existingUserEmails)
    ),
  });
            ...
            <form className="flex flex-col justify-evenly ">
              ...
              <div className="flex justify-between mt-2">
                ...
                {errors.cellPhoneNumber && (
                  <MessageError message={errors.cellPhoneNumber.message} />
                )}
                <div className="flex flex-col w-full">
