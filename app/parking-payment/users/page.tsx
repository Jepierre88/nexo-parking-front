...
const Users = ({ userData, setUserData }: { userData: UserData; setUserData: (userdata: UserData) => void; }) => {
  ...
  return (
    <section>
      <div className="flex justify-between">
        ...
        <Button onPress={onOpen}>+Agregar usuario</Button>
      </div>
          ...
          {() => (
            <div className="flex flex-col items-start w-full p-4">
              <ModalHeader className="flex justify-between w-full">
                <h1 className={`text-2xl ${title()}`}>INFORMACIÓN DE USUARIO</h1>
              </ModalHeader>
              ...
              <div className="flex flex-col items-start w-98 ">
                <div className="flex items-center mt-2 mb-2 w-full">
                  <label className="text-xl font-bold text-nowrap w-1/3">Usuario</label> 
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Contraseña</label>
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Email</label>
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Nombre</label>
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Apellido</label>
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Celular</label>
                  <Input
                ...
                <div className="flex items-center mt-2 mb-2 w-96">
                  <label className="text-xl font-bold text-nowrap w-1/3">Perfil</label>
                ...
                <div className="flex justify-between w-96 mt-4">
                  <Button onClick={() => console.log('Guardar datos')}>Guardar datos</Button>
                  <Button onClick={() => console.log('Limpiar Datos')}>Limpiar Datos</Button>
                </div>
              </div>
            </ModalBody>
            </div>
